...
export function WhatsAppButton({ variant = 'floating' }: WhatsAppButtonProps) {
    ...
    const whatsappUrl = `https://api.whatsapp.com/send?phone=${whatsappNumber}&text=${encodeURIComponent("السلام عليكم، لدي استفسار بخصوص خدماتكم.")}`;
    ...
    if (variant === 'sidebar') {
        return (
            <a
                ...
                className="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 group text-emerald-600 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/10"
            >
                ...
                <span className="font-bold text-sm">تحدث معنا واتساب</span>
            </a>
        );
    }
