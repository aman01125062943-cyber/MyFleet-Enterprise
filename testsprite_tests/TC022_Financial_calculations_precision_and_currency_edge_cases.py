...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError("Test case failed: Expected a confirmation that totals and net profit are displayed with correct decimal precision and proper currency handling (including zero and very large amounts). The success indicator did not appear — this suggests rounding/truncation errors, incorrect currency conversion/handling, or the UI failed to render calculation results.")
        ```
